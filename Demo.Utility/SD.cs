...
namespace Demo.Utility
{
    public static class SD
    {
        ...
        public const string StatusPending = "確認訂單"; // 等待店家確認訂單

        //public const string StatusApproved = "Approved"; 
        //public const string StatusInProcess = "Processing"; // 店家確認後改為訂單準備中
        public const string StatusInProcess = "準備中"; // 店家確認後改為訂單準備中

        //public const string StatusCancelled = "Cancelled"; // 店家或顧客取消訂單
        public const string StatusCancelled = "取消訂單"; // 店家或顧客取消訂單


        //public const string StatusReady = "Ready"; // 店家準備完成，顧客可以取餐
        public const string StatusReady = "可取餐"; // 店家準備完成，顧客可以取餐

        //public const string StatusCompleted = "Completed"; // 顧客取餐及付款後，店家結束訂單
        public const string StatusCompleted = "已完成"; // 顧客取餐及付款後，店家結束訂單
    }
}
